...
public class Type1 extends Drug{
    ...
    public Type1(String name, Double unitaryPrice, Integer quantity, String invimaRegister, String manufacter, LocalDate dueDate, LocalDate manufacturingDate) {
