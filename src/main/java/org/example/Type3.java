...
public class Type3 extends Drug{
    ...
    public Type3(String name, Double unitaryPrice, Integer quantity, String invimaRegister, String manufacter, LocalDate dueDate, LocalDate manufacturingDate) {
