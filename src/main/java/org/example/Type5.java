...
public class Type5 extends Drug{
    ...
    public Type5(String name, Double unitaryPrice, Integer quantity, String invimaRegister, String manufacter, LocalDate dueDate, LocalDate manufacturingDate) {
